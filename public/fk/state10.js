...
demo.state10.prototype = {//state10 
  preload: function(){
    ...
    game.load.spritesheet('200tl', 'assets/tilemaps/ikiyüztl.png', 78, 40);//200Tl
    game.load.spritesheet('100tl', 'assets/tilemaps/yüztl.png', 83, 40);//100Tl
  ...
  create: function(){
    ...
    giris_text = game.add.text(game.world.centerX, 900, "Korsan Kaptan Jack'in 30010 kuruş toplaması lazım.  \n Devam etmek için tıklayın...", { font: "40px Arial", fill: "#84812a", align: "center",backgroundColor: 'rgba(132, 57, 42, 1)' });
    giris_text.anchor.setTo(0.5, 0.5);
    game.input.onDown.addOnce(removeText, this);
    
    //-------------200tl grubu------------
    ikiyüztlS = game.add.group();
    ikiyüztlS.enableBody = true;
    var ikiyüztl = ikiyüztlS.create(0 * 7, 0, '200tl');
      ikiyüztl.x = 800;
      ikiyüztl.y = 450;
    
    //-------------100tl grubu------------
    yüztlS = game.add.group();
    yüztlS.enableBody = true;
    var yüztl = yüztlS.create(0 * 7, 0, '100tl');
      yüztl.x = 50;
      yüztl.y = 50;
  ...
  update: function(){
    ...
    scoreboard = game.add.text(20, 880, "Skor:"+score+"kurus\nAmaç:30010kurus", { font: "40px Arial", fill: "#84812a", align: "center",backgroundColor: 'rgba(132, 57, 42, 1)' });
    ...
    game.physics.arcade.overlap(adam, yüztlS, collect_yüz_tl, null, this);
    game.physics.arcade.overlap(adam, ikiyüztlS, collect_ikiyüz_tl, null, this);
...
if(score > 30010){
    ...
    game.input.onDown.addOnce(removeText_gameover_10, this);
...
if(score==30010){
    ...
    game.input.onDown.addOnce(removeText_state11, this);
...
function collect_ikiyüz_tl(player, ikiyüztl){
...
function removeText_gameover_10() {
...
function removeText_state11(){
    console.log('4.state e gecis');
    kazandin_text.destroy();
    soru_kismi=0;
    game.state.start('state11');//-------------buraya bir bak-------------
    score=0;
