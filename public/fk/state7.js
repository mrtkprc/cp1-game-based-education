...
demo.state7.prototype = {//state7 
  ...
  update: function(){
    ...
    scoreboard = game.add.text(20, 880, "Skor:"+score+"kurus\nAmaç:3510kurus", { font: "40px Arial", fill: "#84812a", align: "center",backgroundColor: 'rgba(132, 57, 42, 1)' });
...
if(score > 3510){
    ...
    game.input.onDown.addOnce(removeText_gameover_7, this);
...
if(score==3510){
    ...
    game.input.onDown.addOnce(removeText_state8, this);
...
function collect_yirmi_tl(player, yirmitl){
...
function removeText_gameover_7() {
