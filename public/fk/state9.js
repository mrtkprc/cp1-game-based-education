...
demo.state9.prototype = {//state9 
  ...
  update: function(){
    ...
    scoreboard = game.add.text(20, 880, "Skor:"+score+"kurus\nAmaç:15025kurus", { font: "40px Arial", fill: "#84812a", align: "center",backgroundColor: 'rgba(132, 57, 42, 1)' });
...
if(score > 15025){
    ...
    game.input.onDown.addOnce(removeText_gameover_9, this);
...
if(score==15025){
    ...
    game.input.onDown.addOnce(removeText_state10, this);
...
function collect_yüz_tl(player, yüztl){
...
function removeText_gameover_9() {
...
function removeText_state10(){
    console.log('4.state e gecis');
    kazandin_text.destroy();
    soru_kismi=0;
    game.state.start('state10');//-------------buraya bir bak-------------
    score=0;
