...
demo.state3.prototype = {//state3 
  ...
  update: function(){
    ...
    scoreboard = game.add.text(20, 880, "Skor:"+score+"kurus\nAmaç:220kurus", { font: "40px Arial", fill: "#84812a", align: "center",backgroundColor: 'rgba(132, 57, 42, 1)' });
    
   // game.physics.arcade.overlap(adam, coinss, collectCoin, null, this);
     // game.physics.arcade.overlap(adam, ontlS, collect_bir_tl, null, this);
...
if(score > 220){
    ...
    game.input.onDown.addOnce(removeText_gameover_3, this);
...
if(score==220){
    ...
    game.input.onDown.addOnce(removeText_state4, this);
...
function collect_on_kurus(player, onkurus){
    console.log('heeeeeeyyy100');
    score+=10;
    console.log(score);
    onkurus.kill();
...
function removeText_gameover_3() {
